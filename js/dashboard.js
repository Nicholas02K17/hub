 ...
 * dashboard.js
 * ---------------------------------------------------------------
 * The collapsible personal dashboard sidebar. Reads entirely from
 * LIF.CURRENT_MEMBER, which is clearly flagged as a sample profile -
 * swap it for the real session data once accounts exist. Visibility
 * is controlled by the "dashboard" feature toggle in More Features.
 * ------------------------------------------------------------- */
...
LIF.dashboard = (function () {
  ...
  function render() {
    ...
    panel.innerHTML =
      ...
      '<button class="btn-text" id="editProfileBtn" style="padding-left:0;" type="button">Edit profile \u2192</button>';
    ...
    var editBtn = U.$('#editProfileBtn', panel);
    if (editBtn) editBtn.addEventListener('click', function () { U.backendPlaceholder('Editing profile'); });
  }
